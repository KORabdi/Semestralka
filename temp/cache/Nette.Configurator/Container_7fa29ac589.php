<?php
// source: /home/users/konstantinkozoka/doge.jecool.net/web/app/config/config.neon 
// source: /home/users/konstantinkozoka/doge.jecool.net/web/app/config/config.local.neon 

class Container_7fa29ac589 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\UserPresenter' => array(array('application.2')),
			'App\Presenters\GalleryPresenter' => array(array('application.3')),
			'App\Presenters\Error4xxPresenter' => array(array('application.4')),
			'App\Presenters\TwitchPresenter' => array(array('application.5')),
			'App\Presenters\ContactPresenter' => array(array('application.6')),
			'App\Presenters\ArticlePresenter' => array(array('application.8')),
			'App\Presenters\ErrorPresenter' => array(array('application.9')),
			'App\Presenters\ArchivePresenter' => array(array('application.10')),
		...
		'services' => array(
			...
			'application.10' => 'App\Presenters\ArchivePresenter',
			...
			'application.2' => 'App\Presenters\UserPresenter',
			'application.3' => 'App\Presenters\GalleryPresenter',
			'application.4' => 'App\Presenters\Error4xxPresenter',
			'application.5' => 'App\Presenters\TwitchPresenter',
			'application.6' => 'App\Presenters\ContactPresenter',
			'application.7' => 'App\Presenters\BasePresenter',
			'application.8' => 'App\Presenters\ArticlePresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/users/konstantinkozoka/doge.jecool.net/web/app',
			'wwwDir' => '/home/users/konstantinkozoka/doge.jecool.net/web',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/home/users/konstantinkozoka/doge.jecool.net/web/app/../temp',
		));
	}
	...
	{
		$service = new App\Presenters\AboutPresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
	...
	/**
	 * @return App\Presenters\ArchivePresenter
	 */
	public function createServiceApplication__10()
	{
		$service = new App\Presenters\ArchivePresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\UserPresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\GalleryPresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\Error4xxPresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\Presenters\TwitchPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\TwitchPresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\ContactPresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\BasePresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\ArticlePresenter($this->getService('database.default.context'), $this->getService('http.request'),
			$this->getService('security.user'), $this->getService('session.session'), $this->getService('http.response'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/users/konstantinkozoka/doge.jecool.net/web/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/users/konstantinkozoka/doge.jecool.net/web/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/users/konstantinkozoka/doge.jecool.net/web/app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=sql.endora.cz:3306;dbname=dogesemestralka', 'doge', 's3EDoucD',
			array('lazy' => TRUE));
	...
	{
		return new Container_7fa29ac589_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/home/users/konstantinkozoka/doge.jecool.net/web/app/../temp/cache/latte');
...
final class Container_7fa29ac589_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_7fa29ac589 $container)
	{
